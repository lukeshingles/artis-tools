    ...
    for estfile in sorted(estimfiles):
        ...
        with opener(estfile, 'rt') as estfile:
            ...
            for line in estfile:
                ...
                if row[0] == 'timestep':
                    if timestep >= 0 and modelgridindex >= 0 and (timestep, modelgridindex) in estimators:
...
def main(args=None, argsraw=None, **kwargs):
    ...
    serieslist = [
        ...
        # [['populations', ['Ar I', 'Ar II', 'Ar III', 'Ar IV', 'Fe V', 'Fe VI', 'Fe VII', 'Fe VIII']]],
        # [['populations', ['Si I', 'Si II', 'Si III', 'Si IV', 'Si V']]],
        # [['populations', ['Cr I', 'Cr II', 'Cr III', 'Cr IV', 'Cr V']]],
        [['populations', ['Fe I', 'Fe II', 'Fe III', 'Co I', 'Co II', 'Co III', 'Ni II', 'Ni III', 'Ar I']]],
